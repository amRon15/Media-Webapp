...
function allMovieView(page,sortType,genre){
  fetch(`https://api.themoviedb.org/3/discover/tv?include_adult=false&include_video=false&language=en-US&page=${page}&sort_by=${sortType}${genre!=null?'&with_genres='+genre:''}`
  , options)
  .then(response => response.json())
  .then(response => {
